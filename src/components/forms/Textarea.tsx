    ...
    <div className="mb-4 w-full bg-gray-50">
      ...
      <div className="bg-white rounded-b-lg">
        ...
        <textarea
          ...
          id={id}
          rows={rows}
          className={`${className} rounded-md block p-4 w-full text-sm text-gray-800 bg-white border  focus:outline-none focus:border-dark focus:ring-1 focus:ring-dark/30 h-48`}
